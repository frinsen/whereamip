...
- DNS detail submenu: expand the DNS row to list each unique resolver with its interface attribution ("192.168.178.1 — global", "10.2.0.1 — utun4 (VPN)") — makes VPN split-DNS visible at a glance.
