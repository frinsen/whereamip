...
final class RenderJSONTests: XCTestCase {
    ...
    func testJSONGolden() {
        ...
        let expected = #"{"connectivity":"online","exit":{"city":"Frankfurt","countryCode":"DE","fetchedAt":"2025-08-12T12:00:00Z","ip":"1.2.3.4","org":"Vodafone GmbH","provider":"ipwho.is"},"ipv6Leak":false,"privateRelay":{"status":"inactive"},"route":{"defaultInterface":"utun4","hijackRoutePresent":false,"isVPN":true,"v6IsVPN":false,"vpnName":"OpenVPN"},"since":"2025-08-12T12:00:00Z"}"#
    ...
    func testJSONGoldenWithIPv6Leak() {
        ...
        s.ipv6Leak = true
        let expected = #"{"connectivity":"online","exit":{"city":"Frankfurt","countryCode":"DE","fetchedAt":"2025-08-12T12:00:00Z","ip":"1.2.3.4","org":"Vodafone GmbH","provider":"ipwho.is"},"exit6":{"city":"Ashburn","countryCode":"US","fetchedAt":"2025-08-12T12:00:00Z","ip":"2001:db8::1","org":"Comcast","provider":"ipwho.is"},"ipv6Leak":true,"privateRelay":{"status":"inactive"},"route":{"defaultInterface":"utun4","hijackRoutePresent":false,"isVPN":true,"v6DefaultInterface":"en0","v6IsVPN":false,"vpnName":"PureVPN"},"since":"2025-08-12T12:00:00Z"}"#
